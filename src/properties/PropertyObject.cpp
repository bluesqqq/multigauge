...
rapidjson::Value PropertyObject::makeRule(
    rapidjson::Document::AllocatorType& a,
    const char* path,
    const char* op,
    const char* value) {
...
rapidjson::Value PropertyObject::makeAllRule(
    rapidjson::Document::AllocatorType& a,
    std::initializer_list<rapidjson::Value> rules) {
...
rapidjson::Value PropertyObject::makeAnyRule(
    rapidjson::Document::AllocatorType& a,
    std::initializer_list<rapidjson::Value> rules) {
    rapidjson::Value group(rapidjson::kObjectType);
...
rapidjson::Value PropertyObject::makeRuleList(
    rapidjson::Document::AllocatorType& a,
    std::initializer_list<rapidjson::Value> rules) {
