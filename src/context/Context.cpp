...
Context::Context(graphics::GraphicsContext& graphicsContext, io::FileSystem& fs, std::string dataRoot,
                 const graphics::UserPalette& userPalette)
    : graphicsContext_(&graphicsContext), graphics_(graphicsContext), assets_(fs, std::move(dataRoot)),
