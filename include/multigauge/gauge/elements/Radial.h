...
public:
    ...
    virtual void draw(::mg::graphics::Graphics&, ::mg::Point<float>, float,const ::mg::ValueView&, float, float) const = 0;
...
public:
    void draw(::mg::graphics::Graphics&, ::mg::Point<float>, float, const ::mg::ValueView&, float, float) const override;
