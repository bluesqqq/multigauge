...
class RootElement : public Element {
    ...
    private:
        ...
        MG_PROPS_BEGIN()
            MG_PROP(title, "title", "Title", "Title to display.", "Content", "Text")
            MG_PROP(description, "description", "Description", "Description to display.", "Content", "Text")
            MG_PROP(backgroundColor, "bgColor", "Background Color", "Color to fill the background with.", "Appearance", "Background")
        MG_PROPS_END()
