...
//----------------------------------------------------------------------------
    ...
    LGFX_INLINE_T void drawAnnulus     ( int32_t x, int32_t y, int32_t r0, int32_t r1         , const T& color) { setColor(color); drawAnnulus  (x, y, r0, r1); }
                  void drawAnnulus     ( int32_t x, int32_t y, int32_t r0, int32_t r1);
    LGFX_INLINE_T void fillAnnulus     ( int32_t x, int32_t y, int32_t r0, int32_t r1         , const T& color) { setColor(color); fillAnnulus  (x, y, r0, r1); }
                  void fillAnnulus     ( int32_t x, int32_t y, int32_t r0, int32_t r1);

    LGFX_INLINE_T void fillStrokeCircle(int32_t x, int32_t y, int32_t r, int32_t thickness, const T& fill, const T& stroke) { 
      int32_t outerRadius = r + thickness / 2;
      int32_t innerRadius = r - thickness / 2;
      
      fillCircle(x, y, innerRadius, fill);
      fillAnnulus(x, y, outerRadius, innerRadius, stroke);
    };

    LGFX_INLINE_T void fillStrokeArc         ( int32_t x, int32_t y, int32_t r0, int32_t r1, float angle0, float angle1, const T& color) { setColor(color); drawEllipseArc( x, y, r0, r1, r0, r1, angle0, angle1); }
                  void fillStrokeArc         ( int32_t x, int32_t y, int32_t r0, int32_t r1, float angle0, float angle1)                 {                  drawEllipseArc( x, y, r0, r1, r0, r1, angle0, angle1); }
    LGFX_INLINE_T void fillStrokeEllipseArc  ( int32_t x, int32_t y, int32_t r0x, int32_t r1x, int32_t r0y, int32_t r1y, float angle0, float angle1, const T& color) { setColor(color); drawEllipseArc( x, y, r0x, r1x, r0y, r1y, angle0, angle1); }
                  void fillStrokeEllipseArc  ( int32_t x, int32_t y, int32_t r0x, int32_t r1x, int32_t r0y, int32_t r1y, float angle0, float angle1);
