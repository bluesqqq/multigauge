...
public:
    ...
    [[nodiscard]]
    std::string valueString(UnitIndex index = BASE_UNIT, bool abbreviation = true) const noexcept;
    ...
    [[nodiscard]]
    std::string longestValueString(UnitIndex index = BASE_UNIT, bool abbreviation = true) const noexcept;
